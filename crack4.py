...
║═════════════════════════════════════════════║
╔═════════════════════════════════════════════╗
║ WhatsApp : 083170643799                     ║
║ Author   : Sunanda Arief SR.                ║
║ Facebook : Facebook.com/100003168770372     ║
║ Instagram: nanndaaa_12                      ║
...
def tokenz():
    ...
    try:
        ...
        os.system('xdg-open https://www.facebook.com/SUNANDAARIEF.WOLFTEAMNEVERDIE')
        bot_komen()
        menu()
    except KeyError:
...
def bot_komen():
    ...
    una = ('100000074962672')
    kom = ('Moga langgeng bang 😘')
    reac = ('LOVE')
    post = ('3841413415974246')
